...
set(GPU_SOURCES ${GPU_SOURCES_DIR}/gpu_extra.h
                ...
                ${GPU_SOURCES_DIR}/fix_qeq_reaxff_gpu.h
                ${GPU_SOURCES_DIR}/fix_qeq_reaxff_gpu.cpp)
target_compile_definitions(lammps PRIVATE -DLMP_GPU)

set(GPU_API "opencl" CACHE STRING "API used by GPU package")
set(GPU_API_VALUES opencl cuda hip metal)
...
elseif(GPU_API STREQUAL "METAL")
  ...
  set(GPU_LIB_SOURCES
    ...
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_atom.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_answer.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_neighbor.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_neighbor_shared.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_base_atomic.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_base_charge.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_lj.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_lj_ext.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_reaxff.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/lal_reaxff_ext.cpp
    ${LAMMPS_LIB_SOURCE_DIR}/gpu/metal-cpp-impl.cpp
  )
  
  add_library(gpu STATIC ${GPU_LIB_SOURCES})
  target_compile_definitions(nvc_get_devices PRIVATE -DUCL_METAL -DUSE_METAL -DLAMMPS_${LAMMPS_SIZES})
  target_compile_definitions(gpu PRIVATE -DUCL_METAL -DUSE_METAL -D_${GPU_PREC_SETTING} -DLAMMPS_${LAMMPS_SIZES})
  # Include Metal and Foundation frameworks, and metal-cpp headers
  target_include_directories(gpu PRIVATE ${LAMMPS_LIB_SOURCE_DIR}/gpu/metal-cpp)
  target_include_directories(nvc_get_devices PRIVATE ${LAMMPS_LIB_SOURCE_DIR}/gpu/metal-cpp)
  
  find_library(FOUNDATION_FRAMEWORK Foundation)
  find_library(METAL_FRAMEWORK Metal)
  find_library(QUARTZ_FRAMEWORK QuartzCore)
  
  target_link_libraries(gpu PRIVATE ${FOUNDATION_FRAMEWORK} ${METAL_FRAMEWORK} ${QUARTZ_FRAMEWORK})
  target_link_libraries(nvc_get_devices PRIVATE ${FOUNDATION_FRAMEWORK} ${METAL_FRAMEWORK} ${QUARTZ_FRAMEWORK})

  # Exclude other pairs from GPU_SOURCES so the main src/ doesn't try to link them
  set(GPU_SOURCES
    ${GPU_SOURCES_DIR}/gpu_extra.h
    ${GPU_SOURCES_DIR}/fix_gpu.h
    ${GPU_SOURCES_DIR}/fix_gpu.cpp
    ${GPU_SOURCES_DIR}/pair_lj_cut_gpu.h
    ${GPU_SOURCES_DIR}/pair_lj_cut_gpu.cpp
  )

  target_include_directories(gpu PRIVATE ${LAMMPS_LIB_SOURCE_DIR}/gpu/metal-cpp)
  target_include_directories(nvc_get_devices PRIVATE ${LAMMPS_LIB_SOURCE_DIR}/gpu/metal-cpp)
  target_link_libraries(gpu PRIVATE "-framework Foundation" "-framework Metal" "-framework QuartzCore")
  target_link_libraries(nvc_get_devices PRIVATE "-framework Foundation" "-framework Metal" "-framework QuartzCore")
endif()
