...
#ifndef GERYON_MTL_PRIMARY_CONTEXT
#define GERYON_MTL_PRIMARY_CONTEXT 1
#endif

#ifdef MPI_GERYON
#include "mpi.h"
#define MTL_GERYON_EXIT do {                                               \
  int is_final;                                                            \
...
#else
#define MTL_GERYON_EXIT assert(0==1)
#endif

#ifndef UCL_GERYON_EXIT
#define UCL_GERYON_EXIT MTL_GERYON_EXIT
#endif
